...
Esse livro não é um livro que ensina programação, algoritmos ou lógica. Seu objetivo é servir de manual para a linguagem G-Portugol
...
texto "Olá mundo". Abra seu editor favorito e crie um arquivo  chamado "olamundo.pt" com o seguinte 
conteúdo:
...
Esse objetivo encontra restrições, quando se leva em consideração o uso e forma popular atual da linguagem portugol, principalmente
em literaturas. É de interesse que G-Portugol ofereça compatibilidade com essas formas, o que pode gerar conflitos quanto
a decisões de design. Portanto, embora as diretrizes marquem a base do design, muitas vezes, elas devem ser 
...
Linguagens de programação, em geral, não se utilizam de caracteres especiais (ex. caracteres não pertencentes a 
tabela ASCII) para definição de seu dicionário, visto que são baseadas na língua inglesa. Portanto, letras acentuadas
não são consideradas. Refletir esse aspecto em G-Portugol evidenciaria justificativas insuficientes.
...
como ``nao'', chamaria atenção constante do estudante para o fato de a palavra não estar acentuada, o que costuma desviar
atenção do estudo.
...
Evitar excessões e surpresas a medida do possível. Isso significa que estruturas e comandos devem ser simples, 
claros e óbvios. Naturalmente, a linguagem portugol já detém uma parcela relevante de características que 
...
``variáveis'' e terminado por ``fim-variáveis''.
...
Objectivo:
	educacao
	-compatibilidade com o uso popular da linguagem (o que impede que seja feita uma nova linguagem)
		-em um futuro, uma nova linguagem poerá ser desenvolvida, de forma que não seja limitada por esse aspecto (e tenha a oportunidade de ser melhor,
		 mais ortogonal, expressiva, etc)
	-abreviacoes/extenso
		-todas as palavras chave devem ser escritas por extenso, de forma a 
			-tornar o algoritmo acessivel para leigos.
			-nao trazer atencao para a linguagem, de forma a ter que aprender seus termos (que são diferentes do uso comum, "int", "var", "proc")

	-uso do imperativo ("imprima, faça") sobre infinitivo ("imprimir","fazer")
  ...
  *As funcoes leia e imprima:
	...
	tratamento de erros:
erá que atrapalha mais do que ajuda continuar a analise sintatica apos errors encontrados?
